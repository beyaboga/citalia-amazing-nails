...
const NavigationSidebar = ({ isCollapsed = false }: NavigationSidebarProps) => {
  ...
  const allNavigationSections: NavigationSection[] = [
    ...
    },
    {
      ...
      items: [
        {
          label: 'Clientes',
          href: '/customer-profile-management',
          icon: 'UserGroupIcon',
    ...
    },
    {
      ...
      items: [
        ...
        {
          label: 'Categorías',
          href: '/service-categories-management',
          icon: 'TagIcon',
          permission: 'services.manage',
        },
        {
          label: 'Descuentos',
          href: '/discount-codes-management',
          icon: 'TicketIcon',
    ...
    },
    {
      ...
      items: [
        ...
        {
          label: 'Propinas',
          href: '/tips-distribution',
          icon: 'SparklesIcon',
          permission: 'tips.distribute',
        },
        {
          label: 'Motivos de Precio',
          href: '/price-change-reasons-management',
          icon: 'AdjustmentsHorizontalIcon',
          permission: 'pricing.modify',
        },
      ],
    },
    {
      ...
      items: [
        ...
        {
          label: 'Reportes de Pago',
          href: '/payroll-reports',
          icon: 'DocumentChartBarIcon',
          permission: 'payroll.configure',
        },
        {
          label: 'Rendimiento por Empleado',
    ...
    },
    {
      ...
      items: [
        {
          label: 'Entregas de Caja',
          href: '/cash-deliveries',
          icon: 'BanknotesIcon',
          permission: 'cash.deliveries.manage',
        },
        {
          label: 'Gastos',
          href: '/expenses',
        ...
        {
          label: 'Reporte de Fondos',
          href: '/reserve-funds-report',
          icon: 'DocumentChartBarIcon',
          permission: 'funds.view',
        },
        {
  ...
  return (
    <>
      ...
      >
        <Icon
          name={isMobileOpen ? 'XMarkIcon' : 'Bars3Icon'}
          size={24}
      ...
      >
        <div className="flex flex-col h-full">
          <div className="flex items-center h-20 px-6 border-b border-border">
            <Link
              href={can('reports.view') ? '/main-dashboard' : '/appointments-calendar'}
